...
import {
  ...
  Calendar, PieChart as PieChartIcon, BarChart3
} from 'lucide-react';
...
export function SalesVolumeChart({ monthlyData = [] }: { monthlyData?: any[] }) {
  return (
    <AdminCard>
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
...
export function HourlyAnalyticsChart({ hourlyData = [] }: { hourlyData?: any[] }) {
  return (
    <AdminCard>
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-lg font-bold text-gray-900">Hourly Sales Pattern</h3>
        </div>
...
export function ProductPerformanceChart({ productData = [] }: { productData?: any[] }) {
  return (
    <AdminCard>
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
      ...
      <div className="h-80">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={cashFlowData}>
            ...
            />
            <Legend />
            <Bar dataKey="inflow" fill="#10b981" name="Income" radius={[2, 2, 0, 0]} />
            <Bar dataKey="outflow" fill="#ef4444" name="Expenses" radius={[2, 2, 0, 0]} />
            <Line 
              type="monotone" 
              dataKey="netFlow" 
              stroke="#f59e0b" 
